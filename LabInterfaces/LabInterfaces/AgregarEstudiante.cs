...
namespace LabInterfaces
{
    ...
    public partial class AgregarEstudiante : Form
    {
        ...
        {
            if(!txtEmail.Text.Contains("DROP") || !txtEmail.Text.Contains("DELETE"))
            {
            ...
            {
                MessageBox.Show("El email contiene datos invàlidos para la base de datos", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
